...
#define __LOTUSCRT_STRINGIZE(x) #x
...
// __LOTUSCRT_DISABLE_CLANG_WARNING
	...
	#define __LOTUSCRT_CLANG_WARNING_HELP1(x) __LOTUSCRT_STRINGIZE(clang diagnostic ignored x)
...
// __LOTUSCRT_MSVC_INTRINSIC
		...
		#define __LOTUSCRT_MSVC_INTRINSIC_HELPER1(x) \
			__LOTUSCRT_STRINGIZE(intrinsic(x))
